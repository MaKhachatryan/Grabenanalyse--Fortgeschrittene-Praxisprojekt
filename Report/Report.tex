...
\begin{abstract}
Enter the text of your abstract here. It appears on its own page because of the clearpage commands.
\end{abstract}
...
Denaxas et al. (2022) claimed something something
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{Report_files/figure-latex/fig2-1.pdf}}
...
Loog (2021) suggests that something something
...
\bibitem[\citeproctext]{ref-denaxas2022mapping}
Denaxas, Spiros, Ge Liu, Qiping Feng, Ghazaleh Fatemifar, Lisa
Bastarache, Eric V Kerchberger, Aroon D Hingorani, et al. 2022.
{``Mapping the Read2/CTV3 Controlled Clinical Terminologies to Phecodes
in UK Biobank Primary Care Electronic Health Records: Implementation and
Evaluation.''} In \emph{AMIA Annual Symposium Proceedings}, 2021:362.
...
\bibitem[\citeproctext]{ref-loog2021sometimes}
Loog, Liisa. 2021. {``Sometimes Hidden but Always There: The Assumptions
Underlying Genetic Inference of Demographic Histories.''}
\emph{Philosophical Transactions of the Royal Society B} 376 (1816):
20190719.
