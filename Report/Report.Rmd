...
```{r fig11, echo=FALSE, fig.cap="Posterior coefficient estimates with 95% credible intervals from the Bayesian models", fig.pos='H'}
...
```{r fig12, echo=FALSE, fig.cap="Predicted probabilities of biological relatedness with 95% credible intervals", fig.pos='H'}
...
```{r fig13, echo=FALSE, fig.cap="Posterior coefficient estimates with 95% credible intervals under flat priors and weakly informative priors N(0,1)", fig.pos='H'}
...
```{r fig14, echo=FALSE, fig.cap="Posterior coefficient estimates with 95% credible intervals comparing the main model and the within-tomb model", fig.pos='H'}
...
```{r fig15, echo=FALSE, fig.cap="Posterior coefficient estimates with 95% credible intervals comparing the main model with a model treating third-degree relationships as unrelated", fig.pos='H'}
